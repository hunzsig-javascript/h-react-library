...
import { AutoComplete, Alert, message, Select, Cascader, Icon, Button, Tree, TreeSelect, Input, Radio } from 'antd';
        ...
        <div>
          {
            ...
            <span style={{ color: '#777777' }}>
              <span style={{ color: this.state.valuesShadow[val.field].length >= val.params.maxLength ? '#e04240' : null }}>
          ...
          <Row wrap>
            ...
            <Col {...defaultCol[c].item} style={styles.formItem}>
              <IceFormBinder
                ...
                valueFormatter={(result) => { return this.binderValueFormatter(val, result); }}
              >
                <Input
      ...
      tpl = (
        <Col key={idx} {...col[c]} align={align}>
          <Row wrap>
            ...
            <Col {...defaultCol[c].item} style={styles.formItem}>
              <IceFormBinder name={val.field} message={I18n.translate('pleaseInputRight') + val.name} valueFormatter={(result) => { return this.binderValueFormatter(val, result); }}>
                <Input.TextArea
                  className={`fromItemWidth${c} ${val.type}`}
                  size={size}
                  placeholder={I18n.translate('pleaseInput') + val.name}
      ...
      tpl = (
        <Col key={idx} {...col[c]} align={align}>
          <Row wrap>
            ...
            <Col {...defaultCol[c].item} style={styles.formItem}>
              <IceFormBinder name={val.field} type="email" message={I18n.translate('pleaseInputRight') + val.name} valueFormatter={(result) => { return this.binderValueFormatter(val, result); }}>
                <AutoComplete
                  className={`fromItemWidth${c} ${val.type}`}
                  size={size}
                  placeholder={I18n.translate('pleaseInput') + val.name}
      ...
      tpl = (
        <Col key={idx} {...col[c]} align={align}>
          <Row wrap>
            ...
            <Col {...defaultCol[c].item} style={styles.formItem}>
              <IceFormBinder type="hex" name={val.field} message={I18n.translate('pleaseInputRightCode')} valueFormatter={(result) => { return this.binderValueFormatter(val, result); }}>
                <CompactPicker
                  className={`fromItemWidth${c} ${val.type}`}
                  {...val.params}
      ...
      tpl = (
        <Col key={idx} {...col[c]} align={align}>
          <Row wrap>
            ...
            <Col {...defaultCol[c].item} style={styles.formItem}>
              <IceFormBinder type="string" name={val.field} message={I18n.translate('pleaseInput') + val.name} valueFormatter={(result) => { return this.binderValueFormatter(val, result); }}>
                <Input.Password
                  className={`fromItemWidth${c} ${val.type}`}
                  type="password"
                  size={size}
      ...
      tpl = (
        <Col key={idx} {...col[c]} align={align}>
          <Row wrap>
            ...
            <Col {...defaultCol[c].item} style={styles.formItem}>
              <IceFormBinder name={val.field} validator={this.checkNumber} valueFormatter={(result) => { return this.binderValueFormatter(val, result); }}>
                <Input
                  className={`fromItemWidth${c} ${val.type}`}
                  size={size}
                  placeholder={I18n.translate('pleaseInput') + val.name}
              ...
              {(this.state.values[val.field] > 0 || this.state.values[val.field] < 0) && <IceFormError name={val.field} style={{ whiteSpace: 'nowrap' }} />}
            </Col>
          </Row>
        </Col>
      );
      ...
      tpl = (
        <Col key={idx} {...col[c]} align={align}>
          <Row wrap>
            ...
            <Col {...defaultCol[c].item} style={styles.formItem}>
              <IceFormBinder name={val.field} validator={this.checkInteger} valueFormatter={(result) => { return this.binderValueFormatter(val, result); }}>
                <Input
                  className={`fromItemWidth${c} ${val.type}`}
                  size={size}
                  placeholder={I18n.translate('pleaseInput') + val.name}
                        ...
                        <Row key={cbcIdx1} wrap>
                          {
                            map.map((cb, cbcIdx2) => {
                              return (
                                <Col
                                  key={cbcIdx2}
                                  {...{ xxs: 24, xs: Math.max(val.checkboxCol || 12), s: Math.max(val.checkboxCol || 12), m: Math.max(val.checkboxCol || 8) }}
                                >
      ...
      tpl = (
        <Col key={idx} {...col[c]} align={align}>
          <Row wrap>
            ...
            <Col {...defaultCol[c].item} style={styles.formItem}>
              <IceFormBinder type={val.binderType || 'string'} name={val.field} message={I18n.translate('pleaseChoose') + val.name}>
                <Select
                  allowClear={!required}
                ...
                >
                  {map.map((m) => {
                    return <Select.Option key={m.value} value={m.value} disabled={m.disabled || false}>{m.label}</Select.Option>;
                  })}
                </Select>
              </IceFormBinder>
              <div><IceFormError name={val.field} /></div>
      ...
      tpl = (
        <Col key={idx} {...col[c]} align={align}>
          <Row wrap>
            ...
            <Col {...defaultCol[c].item} style={styles.formItem}>
              <IceFormBinder type="array" name={val.field} message={I18n.translate('pleaseChoose') + val.name} valueFormatter={(v1, v2) => { return this.binderValueFormatter(val, v1, v2); }}>
                {
                  regionJson &&
                  <Cascader
                    expandTrigger="hover"
      ...
      tpl = (
        <Col key={idx} {...col[c]} align={align}>
          <Row wrap>
            ...
            <Col {...defaultCol[c].item} style={styles.formItem}>
              <IceFormBinder type="array" name={val.field} message={I18n.translate('pleaseChoose') + val.name + I18n.translate('range')}>
                <Range
                  className={`fromItemWidth${c} ${val.type}`}
                  size={size}
                  defaultValue={this.state.values[val.field]}
      ...
      tpl = (
        <Col key={idx} {...col[c]} align={align}>
          <Row wrap>
            ...
            <Col {...defaultCol[c].item} style={styles.formItem}>
              <IceFormBinder name={val.field} message={I18n.translate('pleaseChoose') + val.name} valueFormatter={(date, dateStr) => { return this.binderValueFormatter(val, date, dateStr); }}>
                <DatePicker
                  className={`fromItemWidth${c} ${val.type}`}
                  size={sizeIce}
                  defaultValue={this.state.values[val.field]}
          ...
          <Row wrap>
            ...
            <Col {...defaultCol[c].item} style={styles.formItem}>
              <IceFormBinder
                ...
                valueFormatter={(date, dateStr) => { return this.binderValueFormatter(val, date, dateStr); }}
              >
                <RangePicker
                  className={`fromItemWidth${c} ${val.type}`}
