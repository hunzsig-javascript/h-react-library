  ...
  run: (conf, refresh) => {
    ...
    axios
      ...
      .catch((error) => {
        ...
        switch (status) {
          case 400: error.message = I18n.translate('apiErrorQuery'); break;
          case 401: error.message = I18n.translate('apiErrorNotAuth'); break;
          case 403: error.message = I18n.translate('apiErrorReject'); break;
          case 404: error.message = I18n.translate('apiErrorAbort'); break;
          case 408: error.message = I18n.translate('apiErrorTimeout'); break;
          case 500: error.message = I18n.translate('apiErrorServer'); break;
          case 501: error.message = I18n.translate('apiErrorNotService'); break;
          case 502: error.message = I18n.translate('apiErrorNet'); break;
          case 503: error.message = I18n.translate('apiErrorServiceDisable'); break;
          case 504: error.message = I18n.translate('apiErrorNetTimeout'); break;
          case 505: error.message = I18n.translate('apiErrorNotSupportHttp'); break;
          default: error.message = `${I18n.translate('apiErrorDefault')}(${status})!`;
        }
  ...
  runAll: (conf, refresh) => {
    ...
    scope.forEach((s, idx) => {
      ...
      if (refresh === false && key.length < Http.CacheKeyLimit && ApiLoad(key) !== null) {
        ...
        realKey[idx] = key;
        real.push(axios.post(host, Crypto.encode({ client_id: Auth.getClientId(), scope: s, ...(Array.isArray(params) ? params[idx] : params) }, crypto), header));
      }
    });
